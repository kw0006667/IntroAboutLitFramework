const e={id:6,slug:"chapter-6",title:"生命週期：從 connectedCallback 到 updateComplete",part:2,intro:"完整的生命週期地圖，包含 firstUpdated、updated、willUpdate 的正確使用時機。",sections:[{slug:"wc-lifecycle",title:"Web Components 原生生命週期"},{slug:"lit-lifecycle-map",title:"Lit 生命週期完整地圖"},{slug:"first-updated",title:"firstUpdated 的正確使用"},{slug:"updated-hook",title:"updated() 與副作用處理"},{slug:"will-update",title:"willUpdate() 的計算屬性模式"},{slug:"update-complete",title:"updateComplete Promise 的應用"}],content:`
