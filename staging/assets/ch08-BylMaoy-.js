const t={id:8,slug:"chapter-8",title:"Context API 與跨元件通訊",part:2,intro:"Lit 的 @lit/context 解決方案，與 Event-based 通訊、Slot 模式的比較與選型策略。",sections:[{slug:"communication-patterns",title:"元件通訊模式總覽"},{slug:"event-based",title:"Event-based 通訊"},{slug:"slots-composition",title:"Slots 與元件組合"},{slug:"lit-context-api",title:"@lit/context 深度解析"},{slug:"context-provider-consumer",title:"Provider / Consumer 模式"},{slug:"choosing-pattern",title:"如何選擇通訊策略"}],content:`
