const t={id:15,slug:"chapter-15",title:"Testing 策略：Web Test Runner 與 Playwright",part:4,intro:"單元測試、整合測試的完整工作流，重點說明 Shadow DOM 環境下的元素查詢技巧。",sections:[{slug:"testing-philosophy",title:"測試哲學與策略"},{slug:"web-test-runner-setup",title:"Web Test Runner 環境設定"},{slug:"unit-testing-components",title:"元件單元測試"},{slug:"shadow-dom-querying",title:"Shadow DOM 查詢技巧"},{slug:"playwright-e2e",title:"Playwright E2E 測試"},{slug:"ci-integration",title:"CI/CD 整合"}],content:`
