const t={id:2,slug:"chapter-2",title:"認識 Lit：設計哲學與核心理念",part:1,intro:"Lit 為什麼選擇擁抱平台（Embrace the Platform），而不是抽象它？探討 Lit 的極簡主義設計與零框架鎖定（no framework lock-in）的哲學根基。",sections:[{slug:"embrace-the-platform",title:"Embrace the Platform 哲學"},{slug:"minimalism-design",title:"極簡主義的設計取捨"},{slug:"no-framework-lock-in",title:"零框架鎖定的承諾"},{slug:"lit-architecture-overview",title:"Lit 架構全覽"},{slug:"when-to-choose-lit",title:"何時選擇 Lit？"}],content:`
