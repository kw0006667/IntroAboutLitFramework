const t={id:12,slug:"chapter-12",title:"互通性：在 React 應用中使用 Lit，或反之",part:3,intro:"如何在 React 專案中引入 Lit Web Components，以及 @lit/react wrapper 的使用策略，適合微前端架構的讀者。",sections:[{slug:"web-components-in-react",title:"在 React 中使用 Web Components"},{slug:"lit-react-wrapper",title:"@lit/react Wrapper 詳解"},{slug:"event-interop",title:"事件系統互通"},{slug:"microfrontend-patterns",title:"微前端架構應用"},{slug:"migration-strategy",title:"漸進式遷移策略"}],content:`
