const e={id:18,slug:"chapter-18",title:"WebGL 與 Three.js：Lit 作為 3D 場景的容器",part:5,intro:"用 Lit 封裝 Three.js 場景，管理 WebGL context 的生命週期，以及如何透過 Reactive Properties 驅動 3D 場景的動態變化。",sections:[{slug:"webgl-context-lifecycle",title:"WebGL Context 生命週期管理"},{slug:"threejs-setup",title:"Three.js 場景封裝"},{slug:"reactive-props-3d",title:"Reactive Properties 驅動 3D 場景"},{slug:"resource-cleanup",title:"資源清理與記憶體管理"},{slug:"postprocessing",title:"後處理效果整合"}],content:`
