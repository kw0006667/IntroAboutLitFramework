const e={id:4,slug:"chapter-4",title:"Reactive Properties 與更新週期",part:2,intro:"深入 @property、@state 裝飾器，理解 Lit 的 reactive update cycle，以及如何與瀏覽器的 microtask queue 協作。",sections:[{slug:"property-decorator",title:"@property 裝飾器深探"},{slug:"state-decorator",title:"@state 內部狀態管理"},{slug:"reactive-update-cycle",title:"Reactive Update Cycle 原理"},{slug:"microtask-queue",title:"與 Microtask Queue 的協作"},{slug:"property-options",title:"Property Options 進階配置"},{slug:"observed-attributes",title:"Observed Attributes 與 HTML Attributes"}],content:`
