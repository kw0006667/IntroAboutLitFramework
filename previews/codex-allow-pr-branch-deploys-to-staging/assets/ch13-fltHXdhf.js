const t={id:13,slug:"chapter-13",title:"設計系統與 Component Library 的建構",part:4,intro:"用 Lit 打造跨框架 Design System 的最佳實踐，包含 theming（CSS Custom Properties）、Storybook 整合與版本策略。",sections:[{slug:"design-system-why",title:"為何用 Lit 建設計系統？"},{slug:"css-custom-properties-theming",title:"CSS Custom Properties Theming"},{slug:"token-system",title:"Design Token 系統設計"},{slug:"storybook-integration",title:"Storybook 整合"},{slug:"versioning-strategy",title:"版本策略與 Breaking Changes"},{slug:"publishing-npm",title:"發佈到 npm 的最佳實踐"}],content:`
