const t={id:9,slug:"chapter-9",title:"心智模型的根本差異",part:3,intro:"從「元件是函數」（React）到「元件是 DOM 節點」（Lit）的思維轉換，解釋 Shadow DOM encapsulation 對 CSS 和事件的影響。",sections:[{slug:"function-vs-dom-node",title:"函數 vs DOM 節點的元件觀"},{slug:"shadow-dom-css-impact",title:"Shadow DOM 對 CSS 的影響"},{slug:"event-bubbling-shadow",title:"事件冒泡與 Shadow DOM"},{slug:"react-fiber-vs-lit",title:"React Fiber vs Lit 更新策略"},{slug:"jsx-vs-tagged-templates",title:"JSX vs Tagged Template Literals"}],content:`
