const e={id:20,slug:"chapter-20",title:"Web Workers 與 OffscreenCanvas：將運算移出主執行緒",part:5,intro:"如何將繁重的 Canvas / GPU 運算移至 Worker，透過 OffscreenCanvas 與 Lit 元件通訊，保持 UI 執行緒的流暢度。",sections:[{slug:"why-workers",title:"為何需要 Web Workers？"},{slug:"worker-communication",title:"Worker 通訊設計模式"},{slug:"offscreen-canvas",title:"OffscreenCanvas 轉移"},{slug:"lit-worker-integration",title:"Lit 與 Worker 的整合模式"},{slug:"performance-gains",title:"效能提升實測"}],content:`
