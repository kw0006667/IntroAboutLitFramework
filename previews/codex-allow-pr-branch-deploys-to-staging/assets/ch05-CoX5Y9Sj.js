const t={id:5,slug:"chapter-5",title:"lit-html 模板引擎：Tagged Template Literals 的威力",part:2,intro:"為什麼 Lit 不需要 Virtual DOM？解析 html`` 背後的 Part 系統，以及它如何實現精準的 DOM 更新。",sections:[{slug:"tagged-template-literals",title:"Tagged Template Literals 原理"},{slug:"why-no-vdom",title:"為何不需要 Virtual DOM？"},{slug:"part-system",title:"Part 系統：精準 DOM 更新"},{slug:"binding-types",title:"五種 Binding 類型"},{slug:"dynamic-templates",title:"動態模板與條件渲染"},{slug:"template-caching",title:"模板快取機制"}],content:`
