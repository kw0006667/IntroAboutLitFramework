const t={id:10,slug:"chapter-10",title:"狀態管理的不同路徑",part:3,intro:"React 的 useState/useReducer/Redux 生態 vs. Lit 的 Reactive Properties + MobX/Zustand/Signals 整合方案比較。",sections:[{slug:"react-state-hooks",title:"React useState / useReducer"},{slug:"lit-reactive-state",title:"Lit 的 Reactive Properties"},{slug:"mobx-integration",title:"MobX 與 Lit 整合"},{slug:"zustand-integration",title:"Zustand 跨框架狀態"},{slug:"signals-preview",title:"Signals：下一代響應式原語"},{slug:"state-strategy",title:"狀態管理策略選型指南"}],content:`
